  ...
  <data>
    <template id="report_performa_invoice">
      <t t-call="web.html_container">
          ...
          <div class="content" style="padding-top: 100px; ">
            <t t-foreach="docs" t-as="doc">
             ...
             <div style="margin-top: 10px; text-align: center;">
                <h1 style="font-size: 24px; font-weight: bold;">PROFORMA INVOICE / SALES CONTRACT</h1>
            </div>
            ...
            <!-- INVOICE / SALES CONTRACT</p> -->
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 10px;">
                  <tr>
                    <td style="vertical-align: top; text-align: left; width: 50%;"> <strong>INV:</strong> <span t-field="doc.pi_no" />
                      <br />
                      <span t-field="doc.total_qty" />
                      CARTONS OF VITAL TEA
                    </td>
                  <td style="text-align: left; width: 50%;"> <strong>CONSIGNED TO:</strong> <span t-field="doc.partner_id.name" />
                  <br />
                  <p style="margin: 0; padding: 0;">
                    <strong>DESTINATION:</strong> <span t-field="doc.destination" />
                  </p>
                  <p style="margin: 0; padding: 0;"><strong>PAYMENT TERMS:</strong> <span t-field="doc.producer_code" />
                  </p>
                  <p style="margin: 0; padding: 0;"><strong>NET WEIGHT IN KGs:</strong> <span t-field="doc.total_net_weight" />
                  </p>
                  <p style="margin: 0; padding: 0;"><strong>GROSS WEIGHT IN KGs:</strong> <span t-field="doc.total_gross_weight" />
                  </p>
                  <p style="margin: 0; padding: 0;"><strong>SHIPMENT:</strong> <span t-field="doc.commitment_date" />
                  </p>
                  
                  <p style="margin: 0; padding: 0;"><strong>FDA:</strong> <span t-field="doc.fda" />
                  </p>
                </td>
              </tr>
            </table>
              ...
              <table class="table table-condensed" style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                <thead>
                  <tr style="background-color: #f2f2f2;">
                    ...
                    <th style="padding: 4px; border: 1px solid black;">CTN's</th>
                    <th style="padding: 4px; border: 1px solid black;">DESCRIPTION</th>
                    <th style="padding: 4px; border: 1px solid black;">PACKAGING</th>
                    <th style="padding: 4px; border: 1px solid black;">UNIT PRICE / CARTON</th>
                        ...
                        <t t-if="line.product_id.categ_id.name in sub_category_lst and line.product_id.id not in product_lst">
                          ...
                          <tr>
                            ...
                            <td style="padding: 8px; border: 1px solid black; text-align: right;">
                              <img t-if="line.image" t-att-src="image_data_uri(line.image)" alt="Product Image" style="width: 60px; max-width: 80px; height: 80px;" />
            ...
            <div style="margin-top: 10px; text-align: right;">
              <p style="margin: 0; padding: 0;">FRIEGHT: <strong>$                <span t-field="doc.freight"/>
              </strong>
            </p>
            <p style="margin: 0; padding: 0;">CREDIT NOTE: <strong>$             
            </strong>
          </p>
          <!-- <p style="margin: 0; padding: 0;">NET CNF VALUE: <strong>$            <span t-field="doc.frieght"/>
          </strong>
        </p> -->
        ...
        <p style="margin: 0; padding: 0;">
            <strong>
                <t t-if="doc.total and doc.total > 0">NET CNF VALUE:</t>
                <t t-else="">NET FOB VALUE:</t>
            </strong>
            <span>$ <t t-esc="doc.total or '0.00'"/></span>
        </p>
      </div>
      ...
      <p style="margin: 0; padding: 0;">
            <strong>
                <t t-if="doc.freight and doc.freight > 0">NET CNF VALUE:</t>
                <t t-else="">NET FOB VALUE:</t>
            </strong>
            <span>$ <t t-esc="doc.total or '0.00'"/></span>
        </p>
    ...
    <div style="margin-top: 20px; font-size: 12px; border-top: 1px solid #000; padding-top: 10px;">
      ...
      <p style="margin: 0; padding: 0;">SHIPMENT: WITHIN 25 DAYS AFTER RECEIPT OF SIGNED CONTRACT
      </p>
